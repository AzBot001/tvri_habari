                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="jenis" value="sulampa">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kategori">
                                                ...
                                                ?>
                                                    <option value="<?= $data['id_sumber_berita'] ?>"><?= $data['nama_sumber_berita'] ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group float-right">
                                    <button type="submit" name="simpansulampa" class="btn btn-success">Simpan</button>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
