                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">NASKAH GORONTALO NEWS SERVICE</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="jenis" value="gns">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group float-right">
                                    <button type="submit" name="simpangns" class="btn btn-success">Simpan</button>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
