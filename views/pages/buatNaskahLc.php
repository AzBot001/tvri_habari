<?php
include 'app/controller/reporter/post_naskahlc.php';
?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">NASKAH LIVE CROSS</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="jenis" value="lc">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group float-right">
                                    <button type="submit" name="simpanlc" class="btn btn-success">Simpan</button>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
